...
Callable two ways:
  1. bench console:  bench --site <site> execute ai_dispatch.router.train.train_router
  2. Whitelisted API: POST /api/method/ai_dispatch.api.train_router (System Manager only)
"""
...
from ai_dispatch.rag.embeddings import embed_texts, EMBEDDING_DIM
from ai_dispatch.router.classifier import RouterClassifier, save_model
